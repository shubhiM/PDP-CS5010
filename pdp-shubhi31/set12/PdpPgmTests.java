...
public class PdpPgmTests {
    ...
    public static void main(String[] args) {
        ...
        addTest(tests, readPgm ("set11/vectors.ps11"), 10, 285);
        addTest(tests, readPgm ("set11/vectors.ps11"), 200, 2646700);

        // Church numerals

        addTest(tests, readPgm ("set11/church.ps11"), 4, 24);
        addTest(tests, readPgm ("set11/church.ps11"), 6, 720);

        // Sieve of Eratosthenes

        addTest(tests, readPgm ("set11/sieve.ps11"), 2, 100, 25);
        addTest(tests, readPgm ("set11/sieve.ps11"), 100, 200, 21);

        // Binary search trees

        addTest(tests, readPgm ("set11/bst.ps11"), 5, 3, 1, 9);
        addTest(tests, readPgm ("set11/bst.ps11"), 50, 17, 10, 289);
